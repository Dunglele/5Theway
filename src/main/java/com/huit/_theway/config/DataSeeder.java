...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (categoryRepository.count() == 0) {
            ...
            Category masks = Category.builder().name("MASKS").slug("masks").build();
            Category bags = Category.builder().name("BAGS").slug("bags").build();
            Category stickers = Category.builder().name("STICKERS").slug("stickers").build();
            
            categoryRepository.saveAll(Arrays.asList(tops, hoodies, jackets, accessories, masks, bags, stickers));

            // TOPS & HOODIES & JACKETS mẫu
            Product p1 = Product.builder()
                    .name("LED SIGN /teddy bear/ NEW TEE™")
                    .price(390000.0).salePrice(350000.0).shortDescription("Áo thun in hình gấu bông phản quang cực chất.")
            ...
            Product p2 = Product.builder()
                    ...
                    .price(430000.0).stock(20).featured(true).category(tops)
